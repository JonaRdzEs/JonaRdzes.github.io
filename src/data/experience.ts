...
export const projects: Project[] = [
  {
    ...
    title: "BookMate",
    description:
      "Aplicación web para registrar sesiones de tecnología, desarrollada con React y TypeScript, utilizando Tailwind para el diseño y Redux para la gestión eficiente del estado global.",
    sourceCodeUrl: "",
    url: "https://jonardzes.github.io/book-a-session/",
  },
  {
    image: "/images/projects/event-voyager.png",
    title: "Event Voyager",
    description:
      "Aplicación web para registrar eventos en distintos países, desarrollada con Next.js 12 para optimización y rendimiento, y estilizada con Tailwind para un diseño moderno y adaptable.",
    sourceCodeUrl: "",
    url: "https://events-app-steel.vercel.app/",
  },
  {
    image: "/images/projects/todo-app.png",
    title: "Todo app",
    description:
      "Aplicación de gestión de tareas inspirada en el reto de Frontend Mentor, desarrollada con React y TypeScript, utilizando Tailwind para el diseño y Zustand para una gestión de estado global eficiente.",
    sourceCodeUrl: "",
    url: "https://jonardzes.github.io/to-do-app/",
  },
];
